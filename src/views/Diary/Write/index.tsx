      ...
      <div className='write-container'>
        ...
        <div className='contents-container'>
          ...
          <div className='input-row-box'>
            ...
            <div className={happyContentClass}>
              <div className={happyIconClass} onClick={() => onFeelingChangeHandler('행복')}></div>행복
            </div>
            <div className={funnyContentClass}>
              <div className={funnyIconClass} onClick={() => onFeelingChangeHandler('즐거움')}></div>즐거움
            </div>
            <div className={normalContentClass}>
              <div className={normalIconClass} onClick={() => onFeelingChangeHandler('보통')}></div>보통
            </div>
            <div className={sadContentClass}>
              <div className={sadIconClass} onClick={() => onFeelingChangeHandler('슬픔')}></div>슬픔
            </div>
            <div className={angryContentClass}>
              <div className={angryIconClass} onClick={() => onFeelingChangeHandler('분노')}></div>분노
            </div>
          </div>
