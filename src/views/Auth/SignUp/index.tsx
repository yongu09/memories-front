...
export default function SignUp(props: Props) {
  ...
  const onUserPasswordChangeHandler = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    const regexp = /^(?=.*[a-z])(?=.*[0-9])[a-zA-Z0-9]{8,13}$/;
  ...
  return (
    <div id='auth-sign-up-container'>
      ...
      <div className='input-container'>
        ...
        <InputBox label={'아이디'} type={'text'} value={userId} placeholder={'아이디를 입력해주세요.'} onChange={onUserIdChangeHandler} message={userIdMessage} buttonName={'중복 확인'} onButtonClick={onCheckUseridClickHhandler} isErrorMessage={userIdMessageError} isButtonActive={isUserIdCheckButtonActive} />
